        ...
        do {
            ...
            switch (operace) {
                ...
                case ODEBRANI_NAVSTEVNIKU -> {
                    ...
                    if((chatky[cisloChatky] + pocetNavstevniku) > MAX_VELIKOST_CHATKY) {
                        System.out.println("Překrocen minimální pocet navstevniku chatky");
                        continue;                               
                    }
                ...
                case CELKOVA_OBSAZENOST -> {
                    for ( int i = 0; i < chatky.length; i++) {
                        obsazenost = obsazenost + chatky[i];     
                    }
                    System.out.println("Celková obsazenost chatek je: " + obsazenost);                       
                }

                case VYPIS_PRAZDNE_CHATKY -> {
                    for ( int i = 0; i < chatky.length; i++) {
                        if (chatky[i] != 0) {
                            pocetPrazdnychChatek = pocetPrazdnychChatek - 1;                                   
                        }                       
                    }
                    System.out.println("počet Prázdných chatek je: " + pocetPrazdnychChatek);
                }
